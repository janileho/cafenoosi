    ...
    <div className="min-h-screen bg-white text-black"> 
         ...
         <div className="relative z-10 text-center text-white max-w-6xl mx-auto px-3 sm:px-6">
           {isLoaded && (
             <div className="mb-2 sm:mb-8 md:mb-12">
               <h2 className="text-xl sm:text-6xl md:text-8xl font-light mb-2 sm:mb-6 md:mb-8 tracking-wide leading-tight animate-slide-up">
                  cafe nöösi
                </h2>
               <div className="w-8 sm:w-24 md:w-32 h-px bg-[#A64845] mx-auto mb-2 sm:mb-8 md:mb-10 animate-slide-up delay-100"></div>
          ...
          <div className="md:hidden space-y-4">
            {isLoaded && (
              <div className="max-w-[70%]">
                ...
                <div className="w-6 h-px bg-[#A64845] mb-2 animate-slide-up delay-100"></div>
            ...
            <div className="flex flex-col justify-center space-y-6">
              {isLoaded && (
                <div>
                  ...
                  <div className="w-16 h-px bg-[#A64845] mb-8 animate-slide-up delay-100"></div>
        ...
        <div className="max-w-6xl mx-auto px-3 sm:px-6">
           {isLoaded && (
             <div className="text-center mb-6 sm:mb-16">
              ...
              <div className="w-10 sm:w-16 h-px bg-[#A64845] mx-auto animate-slide-up delay-100"></div>
             </div>
           )}
      ...
      <section id="contact" className="py-8 sm:py-20 bg-white">
         <div className="max-w-4xl mx-auto px-3 sm:px-6 text-center">
           {isLoaded && (
             <>
               ...
               <div className="w-10 sm:w-16 h-px bg-[#A64845] mx-auto mb-6 sm:mb-12 animate-slide-up delay-100"></div>
             </>
           )}
         ...
         <Image
               ...
               <div className="flex flex-col sm:flex-row justify-center space-y-2 sm:space-y-0 sm:space-x-8 animate-slide-up delay-300">
                 <a 
